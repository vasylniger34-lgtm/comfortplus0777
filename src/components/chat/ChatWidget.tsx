...
const BOT_REPLIES: Record<string, string> = {
  ...
  маршрут: 'Наш доступний напрямок: Львів ↔ Стебник ↔ Трускавець ↔ Борислав ↔ Східниця. Зупинки по запиту!',
...
function getBotReply(msg: string): string {
  ...
  if (lower.includes('напрямок') || lower.includes('зупинк')) return BOT_REPLIES.маршрут;
...
export default function ChatWidget() {
  ...
  const quickReplies = ['Розклад', 'Ціни', 'Напрямок', 'Бронювання'];
